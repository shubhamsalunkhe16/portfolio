  ...
  experiences: [
    {
      ...
      projects: [
        ...
        {
          projectTitle: "RAG-Based Social Media Scraper & Analyzer",
          imageArr: [],
          description: [
          ...
          keywords: [
            ...
            "JSON Preprocessing & Token Optimization",
            "Tailwind CSS",
            "Express",
            "SQLite",
            "LLM",
        ...
        {
          projectTitle: "Web-Based Music Streaming Platform",
          imageArr: [
          ...
          keywords: [
            ...
            "Git",
            "Spotify API",
            "Track Trimming (FFmpeg)",
            "Music Analytics (Cyanite)",
            "Algolia Search",
            "Admin Dashboard",
        ...
        },
        {
          ...
          imageArr: [],
          description: [
            "Contributed to a React Native-based educational project for one year",
          ],
          keywords: ["React Native", "Redux", "CSS", "Git", "Responsive UI"],
        },
      ],
    },
  ],
